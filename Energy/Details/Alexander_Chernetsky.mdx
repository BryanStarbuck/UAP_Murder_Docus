---
title: "Alexander Chernetsky"
description: "Soviet physicist who demonstrated a plasma generator producing five times more energy output than input, then died in a car accident after coming to the..."
keywords:
...
<Head>
  <script type="application/ld+json">{"{\"@context\":\"https://schema.org\",\"@type\":\"Person\",\"name\":\"Alexander Chernetsky\",\"description\":\"Soviet physicist who demonstrated a plasma generator producing five times more energy output than input, then died in a car accident after coming to the...\",\"url\":\"https://uapmurders.com/energy/Details/Alexander_Chernetsky\",\"image\":\"https://uapmurders.com/img/social-card-2026-08.jpg\"}"}</script>
</Head>
...
- [Nikola Tesla](/uaps/Details/Nikola_Tesla/) — Another researcher working on vacuum energy extraction
- [Thomas Bearden](/uaps/Details/Thomas_Bearden/) — American researcher who also worked on vacuum energy theories
- [Floyd Sweet](/uaps/Details/Floyd_Sweet/) — Vacuum Triode Amplifier inventor who also claimed to extract energy from the vacuum
- [Ken Shoulders](Ken_Shoulders.mdx) — Researcher who studied charge clusters and exotic vacuum objects with energy implications
- [Dimitri Petronov](/uaps/Details/Dimitri_Petronov/) — Russian plasma battery inventor who disappeared after demonstrating his technology to military officials
- [Paulo Correa](/uaps/Details/Paulo_Correa/) — Researcher who developed plasma-based energy devices and reported anomalous energy output
- [Bruce DePalma](/uaps/Details/Bruce_DePalma/) — N-Machine inventor who researched rotational inertial field effects
- [Paramahamsa Tewari](Paramahamsa_Tewari.mdx) — Indian physicist who developed a space vortex theory and over-unity generator
- [Joseph Papp](Joseph_Papp.mdx) — Noble gas engine inventor. Demonstration exploded, killing one observer. Died of cancer after decades of obstruction
...
- [Floyd Sweet](/uaps/Details/Floyd_Sweet/): Received death threats after demonstrating his Vacuum Triode Amplifier. All research materials confiscated the day after his death.
