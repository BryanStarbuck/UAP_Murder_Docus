...
- [Nikola Tesla](Nikola_Tesla.mdx) — His papers were seized by the U.S. government after death; also worked on extracting energy from the vacuum
- [Thomas Bearden](Thomas_Bearden.mdx) — Inventor of the Motionless Electromagnetic Generator; collaborated on vacuum energy theory
- [John Searl](John_Searl.mdx) — Searl Effect Generator also claimed reactionless properties; devices seized, home burned
...
- [Andrija Puharich](Andrija_Puharich.mdx): Home destroyed by arson attributed to CIA threats, fled to Mexico, died falling down stairs.
