...
- **Pattern consistency:** Moray's experience — public demonstrations followed by attacks, theft, and destruction — matches the pattern seen with other energy inventors including [Nikola Tesla](Nikola_Tesla.md) and [Stanley Meyer](Stanley_Meyer.md)
