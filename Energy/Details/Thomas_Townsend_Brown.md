...
- [Nikola Tesla](Nikola_Tesla.md) — Inventor whose papers were seized by the government and whose wireless energy research was defunded
...
- [Rory Johnson](Rory_Johnson.md): DOE issued gag and grab orders on his magnetic motor. Fled at midnight. Died in California.
- [Al Wordsworth](Al_Wordsworth.md): Built overunity generator (3A in, 32A out). Both devices confiscated. Never returned.
- [Richard Pugh](Richard_Pugh.md): MOD consultant found with feet bound, plastic bag on head, rope around body. Ruled "accident."
