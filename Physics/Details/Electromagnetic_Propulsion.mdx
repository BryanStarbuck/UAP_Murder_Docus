---
title: "Electromagnetic / Electrogravitics Propulsion"
description: "The thesis that UAPs use extremely high-voltage electromagnetic fields to generate propulsive force — either through direct interaction with gravity..."
keywords:
...
<Head>
  <script type="application/ld+json">{"{\"@context\":\"https://schema.org\",\"@type\":\"Article\",\"headline\":\"Electromagnetic / Electrogravitics Propulsion\",\"description\":\"The thesis that UAPs use extremely high-voltage electromagnetic fields to generate propulsive force — either through direct interaction with gravity...\",\"image\":\"https://uapmurders.com/img/social-card-2026-08.jpg\",\"author\":{\"@type\":\"Organization\",\"name\":\"UAP Murders Investigation\"},\"publisher\":{\"@type\":\"Organization\",\"name\":\"UAP Murders Investigation\",\"logo\":{\"@type\":\"ImageObject\",\"url\":\"https://uapmurders.com/img/logo.svg\"}},\"mainEntityOfPage\":\"https://uapmurders.com/physics/Details/Electromagnetic_Propulsion\",\"inLanguage\":\"en-US\"}"}</script>
</Head>
...
**2026 Update — Buhler / Exodus Propulsion:** [Charles Buhler](Charles_Buhler.mdx), Lead Scientist at NASA Kennedy Space Center's Electrostatics Physics Laboratory, presented results at Deep Tech Week NYC 2026 claiming **2 millinewtons of thrust at 6,000 volts in $10^{-6}$ Torr hard vacuum**, replicated across more than 2,000 trials with third-party verification. Unlike prior vacuum tests that found diminished or absent thrust, Buhler claims robust and reproducible vacuum thrust. Critical caveat: Buhler explicitly uses grounded ITO-shielded enclosures in all tests — the test article is not fully isolated. Whether the force persists with a fully floating, groundplane-free geometry remains untested. If Buhler's result survives that test, it would constitute the most significant vacuum electrogravitics result since Brown's 1955-1956 Paris experiments. [Dr. Sonny White](https://en.wikipedia.org/wiki/Harold_Sonny_White), former director of NASA Eagleworks advanced propulsion lab (Warp Drive / EM Drive), was also present at the event with his own test article.
...
## The BROWN-CAHILL Method (2026)

On January 25, 2026 — in the middle of a documented cluster of deaths and disappearances of US scientists working on plasma physics, advanced propulsion materials, nuclear/thorium power, and dual-use aerospace sensors — an X account identified as @TMBSPACESHIPS ("Retired 38 year Active Duty USAF PhD Engineer. AFIT/AETC/AFMC — UT/OU") posted a diagram in a low-visibility reply thread. The post received only 23 likes and 1,825 views.

The diagram is labeled **"BROWN-CAHILL METHOD for the REDUCTION of KINETIC PERMITTIVITY of FREE SPACE"** and is described as open-source technology that, according to the account's author, could enable travel to Mars in minutes.

**Core technical components of the diagram:**

- Incandescently heated thorium-zirconium coated antenna for hot-electron production
- Plasma with two velocity domains: slow ions and fast electrons confined in self-contained laminar 2D sheets
- Diaphragm drive coils with low-frequency ion modulation for kinetic ion transport
...
The account's author states that the United States has had operational "Spaceworthy" antigravity vehicles since the mid-1960s and is writing a 3-volume *Antigravity Vehicle Technology Handbook*. The account continued posting related schematics through February 2026 — covering muon-catalyzed fusion, electro-acoustic waves, magnetic stochastics, 2DOF lattice fields, helium ionization to He+(+5/+6) — along with photographs of modern-looking disc and triangle craft claimed to be operational in manned, unmanned, and slave configurations.

**Domain overlap with the scientist cluster:**

Independent researcher @TruthXVector noted on April 15, 2026 that the BROWN-CAHILL METHOD diagram's subsystems map precisely onto the specializations of the scientists who died or disappeared in the 2023–2026 cluster:

| BROWN-CAHILL Subsystem | Scientist / Expertise |
|------------------------|----------------------|
| Plasma two-velocity domains | Nuno Loureiro — MIT plasma physicist, shot Dec 2025 |
| High-temperature propulsion materials | Monica Jacinto Reza — Mondaloy superalloy co-inventor, missing June 2025 |
| Nuclear/thorium-adjacent power | Anthony Chavez — LANL veteran, vanished May 2025; Melissa Casias — LANL top-secret clearance admin, vanished June 2025 |
| AFRL propulsion oversight | William "Neil" McCasland — retired AFRL commander, missing Feb 2026 |
| Dual-use aerospace sensors | Carl Grillmair — NEOWISE/NEO Surveyor astrophysicist, shot Feb 2026; Michael David Hicks — DART/comet physicist, died July 2023; Frank Maiwald — JPL microwave systems, died July 2024 |

No mainstream circulation of this diagram has been identified. It is not in any public textbook or patent database.

<img
  src="/images/2044216591840125300_1.jpg"
  alt="BROWN-CAHILL METHOD for the REDUCTION of KINETIC PERMITTIVITY OF FREE SPACE — claimed antigravity propulsion schematic posted January 25, 2026 by @TMBSPACESHIPS"
  style={{maxHeight: '25vh', width: 'auto', aspectRatio: '2048/1047'}}
/>

*The BROWN-CAHILL METHOD diagram — alleged open-source antigravity propulsion technology integrating thorium-zirconium plasma antennas, two-velocity laminar plasma sheets, and magnetoacoustic wave propulsion. Source: [@TruthXVector on X](https://x.com/TruthXVector/status/2044216591840125300), April 15, 2026. Original diagram by @TMBSPACESHIPS, posted January 25, 2026.*
...
- [@TruthXVector — US Scientist Cluster & BROWN-CAHILL METHOD Diagram — X](https://x.com/TruthXVector/status/2044216591840125300) — April 15, 2026 post documenting the pattern of 8 dead/missing US scientists whose specializations map exactly onto the subsystems of the BROWN-CAHILL antigravity diagram
