...
- [Thomas Townsend Brown](Thomas_Townsend_Brown.mdx) — Earlier antigravity pioneer whose electrogravitics research was classified and suppressed
- [Nikola Tesla](Nikola_Tesla.mdx) — Named alongside "Eugene" by Amy Eskridge as an antigravity discoverer
- [Ning Li](Ning_Li.mdx) — Superconductor-based antigravity researcher at University of Alabama in Huntsville whose work was also classified
