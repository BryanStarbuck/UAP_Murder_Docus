...
- [Bob Lazar](Bob_Lazar.md) — Claims to have reverse-engineered alien craft using Element 115 as fuel; McKinnon was searching for evidence of exactly this kind of classified program
- [Hal Puthoff](Hal_Puthoff.md) — Physicist whose zero-point energy research aligns with the "free energy suppression" thesis that motivated McKinnon's hacking
- [David Grusch](David_Grusch.md) — UAP whistleblower who testified under oath about recovered non-human craft and reverse-engineering programs, corroborating the type of programs McKinnon claimed to find evidence of
- [Luis Elizondo](Luis_Elizondo.md) — Former AATIP director whose disclosures support the existence of classified UAP programs within military infrastructure

## See Also

- [Zero_Point_Energy](Zero_Point_Energy.md) — The suppressed energy technology McKinnon was specifically searching for
- [Electromagnetic_Propulsion](Electromagnetic_Propulsion.md) — Propulsion systems potentially referenced in the classified programs McKinnon accessed
- [Gravity_Manipulation](Gravity_Manipulation.md) — Antigravity technology that McKinnon believed was being hidden from the public
