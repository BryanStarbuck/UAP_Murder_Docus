...
- [Jason Thomas (UAP Deaths)](/uaps/Details/Jason_Thomas) — Full profile in the UAPs Murders section
...
- [Holistic_Doctor_Deaths](Holistic_Doctor_Deaths.mdx) — Pattern of alternative medicine practitioners and cancer researchers dying under suspicious circumstances since 2015
- [Timothy_Cunningham](Timothy_Cunningham.mdx) — CDC epidemiologist, similar pattern: all belongings left behind, body found in water weeks later
