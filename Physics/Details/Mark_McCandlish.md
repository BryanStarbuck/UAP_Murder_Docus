...
McCandlish proposed that the ARV operated on the principle of electrogravitics — the same fundamental physics explored by [Thomas Townsend Brown](Thomas_Townsend_Brown.md) in the 1920s-1950s, but scaled up enormously. When the capacitor array was charged to megavolt potentials, the resulting electromagnetic field created a localized spacetime distortion that reduced the inertial mass of the craft and generated propulsive thrust.
...
McCandlish argued that the craft's design was fundamentally consistent across multiple independent witness accounts, patent filings, and theoretical frameworks. The convergence of [Brown](Thomas_Townsend_Brown.md)'s electrogravitics experiments, [Salvatore Pais](Salvatore_Pais.md)'s Navy patents describing high-energy electromagnetic field propulsion, and the ARV design all pointed to the same underlying technology.
...
- **Convergence with Brown's electrogravitics**: The ARV's capacitor-based propulsion system is a direct scale-up of [Thomas Townsend Brown](Thomas_Townsend_Brown.md)'s Biefeld-Brown effect experiments, which demonstrated thrust from high-voltage asymmetric capacitors
- **Consistency with Navy patents**: [Salvatore Pais](Salvatore_Pais.md)'s Navy patents (2016-2019) describe craft using "high energy electromagnetic field generators" for inertial mass reduction — the same fundamental mechanism McCandlish proposed for the ARV
...
- [Electromagnetic Propulsion](Electromagnetic_Propulsion.md) — The thesis profile covering electrogravitics, with the ARV as a key evidence point
- [Thomas Townsend Brown](Thomas_Townsend_Brown.md) — The ARV propulsion system is a scaled-up version of Brown's electrogravitics experiments
- [Gravity Manipulation](Gravity_Manipulation.md) — The ARV operates by generating localized gravitational fields
- [Salvatore Pais](Salvatore_Pais.md) — Navy patents describing high-energy electromagnetic field propulsion that parallel the ARV design
- [Bob Lazar](Bob_Lazar.md) — Describes a different propulsion mechanism (Element 115) but similar craft capabilities
- [David Grusch](David_Grusch.md) — Testified about classified programs involving recovered and reverse-engineered craft
- [Hal Puthoff](Hal_Puthoff.md) — Vacuum engineering framework under which the ARV's physics would operate
- [Zero Point Energy](Zero_Point_Energy.md) — The energy source the ARV capacitor system may be tapping
- [Luis Elizondo](Luis_Elizondo.md) — Former AATIP director whose "Five Observables" match the ARV's predicted capabilities
