...
- **Convergence with other researchers**: Li's superconductor-based approach to gravity modification parallels work by Podkletnov, and exists within the same theoretical space as [Hal Puthoff](Hal_Puthoff.md)'s vacuum engineering and [Salvatore Pais](Salvatore_Pais.md)'s Navy patents
...
- [Gravity Manipulation](Gravity_Manipulation.md) — The broader thesis profile on antigravity propulsion, where Li is a key figure
- [Hal Puthoff](Hal_Puthoff.md) — Vacuum engineering approach to gravity manipulation, complementary to Li's superconductor approach
- [Salvatore Pais](Salvatore_Pais.md) — Navy patents describing gravity manipulation devices that exist in the same theoretical space as Li's work
- [Bob Lazar](Bob_Lazar.md) — Describes gravity amplification via Element 115, a different mechanism targeting the same capability
- [Thomas Townsend Brown](Thomas_Townsend_Brown.md) — Electrogravitics pioneer, earlier approach to electromagnetic-gravitational coupling
- [Zero Point Energy](Zero_Point_Energy.md) — Some overlap between vacuum energy physics and Li's superconductor-based approach
- [David Grusch](David_Grusch.md) — Testified about classified programs involving recovered craft; Li's work may have been absorbed into such programs
...
- [Ning Li (Zero Point Energy)](/energy/Details/Ning_Li) — Profile in the suppressed energy technology project
