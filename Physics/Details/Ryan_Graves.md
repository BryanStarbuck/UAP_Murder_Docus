...
- [David Grusch](David_Grusch.md) — Testified alongside Graves in July 2023; his claims about recovered craft programs provide potential context for what Graves observed
- [Luis Elizondo](Luis_Elizondo.md) — Former AATIP director whose program investigated the same class of UAP encounters Graves reported
- [Bob Lazar](Bob_Lazar.md) — Claims the propulsion system he observed at S-4 would produce exactly the flight characteristics Graves describes: hover, instant acceleration, no exhaust
- [Salvatore Pais](Salvatore_Pais.md) — Navy patent holder whose "Craft Using an Inertial Mass Reduction Device" describes technology that could theoretically produce Graves's observed flight characteristics

## See Also

- [Gravity_Manipulation](Gravity_Manipulation.md) — The stationary hover and instant acceleration Graves describes are consistent with localized gravity field manipulation
- [Electromagnetic_Propulsion](Electromagnetic_Propulsion.md) — The absence of exhaust and thermal signatures suggests electromagnetic rather than thermodynamic propulsion
- [Exotic_Metamaterials](Exotic_Metamaterials.md) — The cube-in-sphere morphology may relate to metamaterial-based propulsion or shielding structures
- [Zero_Point_Energy](Zero_Point_Energy.md) — The 12+ hour flight duration without refueling implies an energy source far beyond conventional fuel
- [Alcubierre_Warp_Drive](Alcubierre_Warp_Drive.md) — Theoretical framework that could explain the absence of sonic booms and inertial effects during hypersonic acceleration
