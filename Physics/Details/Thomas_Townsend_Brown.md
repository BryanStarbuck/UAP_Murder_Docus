...
4. **ARV connection**: [Mark McCandlish](Mark_McCandlish.md)'s detailed testimony about the Alien Reproduction Vehicle describes a propulsion system based on stacked capacitor plates at million-volt potentials — essentially a scaled-up version of Brown's concept
...
- [Electromagnetic Propulsion](Electromagnetic_Propulsion.md) — The thesis profile covering electrogravitics, with Brown as the foundational figure
- [Gravity Manipulation](Gravity_Manipulation.md) — Broader thesis on antigravity propulsion, citing Brown as earliest modern experimenter
- [Mark McCandlish](Mark_McCandlish.md) — Aerospace illustrator whose ARV/Flux Liner designs are essentially scaled-up Brown electrogravitics
- [Bob Lazar](Bob_Lazar.md) — Describes gravity amplification via different mechanism (Element 115) but similar flight characteristics
- [Hal Puthoff](Hal_Puthoff.md) — Has explored ZPF explanations for the Biefeld-Brown effect in the context of vacuum engineering
- [Salvatore Pais](Salvatore_Pais.md) — Navy patents describe high-energy EM field propulsion that parallels Brown's concepts at higher energy scales
- [Zero Point Energy](Zero_Point_Energy.md) — Some researchers connect the Biefeld-Brown effect to zero-point field interactions
- [Ning Li](Ning_Li.md) — Superconductor-based antigravity research, a different approach to the same goal Brown pursued
