...
| Thesis | Category | Evidence Rating | Details |
|--------|----------|-----------------|---------|
| [Alcubierre Warp Drive / Spacetime Warping](Details/Alcubierre_Warp_Drive.md) | Spacetime / FTL | **MODERATE EVIDENCE** | A craft could contract spacetime ahead and expand it behind, creating a "warp bubble" that moves faster than light without violating relativity. Proposed by Alcubierre (1994), with recent breakthroughs by Lentz and Bobrick reducing energy requirements. NASA Eagleworks conducted experiments. |

### Faster-Than-Light & Dimensional Physics

| Thesis | Category | Evidence Rating | Details |
|--------|----------|-----------------|---------|
| [Interdimensional / Extra-Dimensional Hypothesis](Details/Interdimensional_Hypothesis.md) | Dimensional Physics | **SPECULATIVE** | UAPs operate through dimensions beyond the four we normally perceive, transitioning between dimensional states rather than traveling through conventional space. Proposed by [Vallee](Details/Jacques_Vallee.md) (1969), formalized in AAWSAP DIRDs on extra dimensions and wormholes. Hinted at by [Elizondo](Details/Luis_Elizondo.md) ("somber") and other insiders. |

### Exotic Materials & Metamaterials

| Thesis | Category | Evidence Rating | Details |
|--------|----------|-----------------|---------|
| [Exotic Metamaterials & Recovered Materials](Details/Exotic_Metamaterials.md) | Materials | **STRONG EVIDENCE** | Physically recovered UAP materials exhibit non-terrestrial isotopic ratios, impossible layered structures, and anomalous electromagnetic properties. Analyzed by Stanford professor [Garry Nolan](Details/Garry_Nolan.md) and others. May function as engineered waveguides for exotic propulsion. Congressional testimony under oath references recovered craft. |
...
|------|------|----------|-----------------|---------|
| [David Grusch](Details/David_Grusch.md) | Intelligence Officer / Whistleblower | Congressional testimony, media | **STRONG EVIDENCE** | Former NGA/NRO intelligence officer who testified under oath about multi-decade UAP crash retrieval and reverse-engineering programs. Filed IG complaint deemed "credible and urgent." |
| [Luis Elizondo](Details/Luis_Elizondo.md) | Former AATIP Director | Books, podcasts, media | **STRONG EVIDENCE** | Former head of the Pentagon's AATIP program. Codified the "Five Observables" of UAP encounters. Author of #1 NYT bestseller *Imminent* (2024). Describes UAP physics as spacetime manipulation via energy-skin interaction. |
| [William McCasland](Details/William_McCasland.md) | Retired USAF Major General | TTSA, classified programs | **MODERATE EVIDENCE** | Former commander of Air Force Research Laboratory ($4.4B budget). Directed advanced propulsion, plasma science, and directed energy programs. Primary source for Tom DeLonge's TTSA initiative. Missing since February 2026. |
| [Bob Lazar](Details/Bob_Lazar.md) | Claimed Insider | Interviews, book | **DEBATED** | Claims to have worked at S-4 near Area 51 reverse-engineering alien propulsion using Element 115 gravity amplification. Predicted Element 115 fourteen years before synthesis. Most-watched JRE episode (63M+ views). |
| [Boyd Bushman](Details/Boyd_Bushman.md) | Lockheed Martin Senior Scientist | Deathbed video, patents | **SPECULATIVE** | Holder of 26 aerospace patents. Conducted gravity-magnetic field experiments at Lockheed. Made deathbed claims about reverse-engineering alien technology at Area 51 involving antigravity and exotic materials. |
| [Phil Schneider](Details/Phil_Schneider.md) | Government Geologist / Engineer | Lectures | **SPECULATIVE** | Claimed involvement building deep underground military bases. Described alien weapon technology and exotic directed energy effects. Displayed physical injuries he attributed to exotic weapons encounters. |
| [Philip Corso](Details/Philip_Corso.md) | Lt. Colonel, U.S. Army | Book (*The Day After Roswell*) | **SPECULATIVE** | Claims he oversaw seeding of recovered Roswell artifacts to defense contractors (IBM, Hughes, Bell Labs, Dow Corning), leading to integrated circuits, fiber optics, lasers, and Kevlar. Headed Foreign Technology at Army R&D. |
| [Harald Malmgren](Details/Harald_Malmgren.md) | Diplomat / Advisor | Interviews | **SPECULATIVE** | Claimed to have handled UFO debris and witnessed a craft shoot-down in 1962. Key claims debunked by declassified FBI files showing fabricated clearance history. Serves as cautionary case study for evidence verification. |
| [Gary McKinnon](Details/Gary_McKinnon.md) | Hacker / Researcher | Court proceedings, interviews | **MODERATE EVIDENCE** | Accessed 97 US military and NASA computers searching for UFO technology and free energy suppression. Found references to "Non-Terrestrial Officers" and evidence of NASA satellite image tampering showing craft removal. |

### Scientists & Researchers

| Name | Role | Platform | Evidence Rating | Details |
|------|------|----------|-----------------|---------|
| [Garry Nolan](Details/Garry_Nolan.md) | Stanford Professor | Papers, conferences, interviews | **STRONG EVIDENCE** | Most credentialed mainstream scientist publicly analyzing UAP materials. Co-authored peer-reviewed methodology paper with Vallee. Found anomalous isotope ratios and brain anomalies in UAP experiencers. Co-founded Sol Foundation. |
| [Hal Puthoff](Details/Hal_Puthoff.md) | Physicist / Intelligence Insider | Papers, patents, conferences | **STRONG EVIDENCE** | Chief architect of the spacetime metric engineering framework. Co-author of the 1994 HRP inertia-ZPF paper. Coordinated all 38 AAWSAP DIRDs. Former CIA/NSA. Co-founded TTSA and EarthTech International. |
| [Eric Davis](Details/Eric_Davis.md) | Astrophysicist | Papers, congressional briefings | **STRONG EVIDENCE** | Authored multiple DIRDs on wormholes, ZPE extraction, and antigravity. Briefed Congress on "off-world vehicles not made on this earth." Stated UAPs use "a new physics" but "no laws of physics are broken." |
| [Jacques Vallee](Details/Jacques_Vallee.md) | Computer Scientist / Astrophysicist | Books, conferences | **STRONG EVIDENCE** | Pioneered the interdimensional hypothesis (1969). Collected materials from 15+ UAP cases. Co-authored peer-reviewed metamaterials paper with Nolan. Five decades of research. Model for Lacombe in *Close Encounters*. |
| [Salvatore Pais](Details/Salvatore_Pais.md) | Navy Aerospace Engineer | Patents | **DEBATED** | Filed 5 exotic physics patents for the US Navy describing inertial mass reduction, gravitational wave generation, and compact fusion. Navy CTO intervened to get patents approved citing Chinese competition. No working prototype confirmed. |
...
| [Ning Li](Details/Ning_Li.md) | Physicist | Peer-reviewed papers, DOD grant | **STRONG EVIDENCE** | Published in Physical Review on gravitomagnetic amplification via rotating superconductor lattice ions. Received $448,970 DOD antigravity grant. Results apparently classified. Struck by vehicle causing permanent brain damage. |
| [Mark McCandlish](Details/Mark_McCandlish.md) | Aerospace Illustrator / Disclosure Witness | Testimony, technical illustrations | **MODERATE EVIDENCE** | Created detailed technical illustrations of the Alien Reproduction Vehicle (ARV/Flux Liner) based on eyewitness accounts. Described 48-plate capacitor array, mercury plasma, and megavolt electrogravitics propulsion. Died before planned Senate testimony. |
...
| [Eugene Mallove](Details/Eugene_Mallove.md) | Science Writer / Cold Fusion Advocate | Books, *Infinite Energy* magazine | **MODERATE EVIDENCE** | Editor of *Infinite Energy* magazine. Championed LENR/cold fusion as compact nuclear-scale energy without radiation. Alleged MIT data manipulation to discredit cold fusion. Beaten to death in 2004. |
| [Stanley Meyer](Details/Stanley_Meyer.md) | Inventor | Patents, demonstrations | **DEBATED** | Developed water fuel cell using resonant electrolysis (high-voltage pulsing at molecular resonant frequency). Held US Patents 4,936,961 and 5,149,407. Died suddenly in 1998, reportedly exclaiming "They poisoned me." |
| [Bruce DePalma](Details/Bruce_DePalma.md) | MIT Physicist / Inventor | Papers, experiments | **DEBATED** | Invented the N-Machine homopolar generator claiming over-unity energy output. His Spinning Ball Experiment suggested rotation alters gravitational/inertial interaction. Proposed a "Primordial Energy Field" connected to vacuum energy. |
...
| [Thomas Townsend Brown](Details/Thomas_Townsend_Brown.md) | Physicist / Inventor | Papers, experiments, patents | **STRONG EVIDENCE** | Pioneer of electrogravitics. Discovered the Biefeld-Brown effect — asymmetric capacitors generating anomalous thrust. His Project Winterhaven proposed electrogravitic craft. Research openly published until ~1956, then abruptly classified. |
...
| [Nikola Tesla](Details/Nikola_Tesla.md) | Inventor / Physicist | Patents, papers, demonstrations | **STRONG EVIDENCE** | Pioneer of AC electricity, wireless energy transmission, and directed energy. FBI and Office of Alien Property seized ~80 trunks of papers after death; ~20 trunks remain unaccounted for. Multiple energy and propulsion concepts anticipated UAP physics. |
...
| [Floyd Sweet](Details/Floyd_Sweet.md) | GE Magnetics Specialist / Inventor | Papers, demonstrations | **SPECULATIVE** | Developed the Vacuum Triode Amplifier using conditioned barium ferrite magnets, claiming 500W output from 330μW input. Reported anomalous cooling and 90% weight reduction during operation — linking vacuum energy extraction to gravity effects. |
...
| [Stefan Marinov](Details/Stefan_Marinov.md) | Physicist | Papers, experiments | **SPECULATIVE** | Challenged special relativity with experimental measurements. Built the Marinov Motor claiming anomalous torque generation. Researched free energy and vacuum energy at University of Graz. Died in 1997 fall, ruled suicide. |
...
| [Jason Thomas](Details/Jason_Thomas.md) | Scientist — Chemical Biology | Novartis / DOD contracts | **EMERGING** | Assistant director of chemical biology at Novartis (active DOD contracts). Vanished December 12, 2025, three days before [Nuno Loureiro](Details/Nuno_Loureiro.mdx) was killed 10 miles away. Body recovered from Lake Quannapowitt after ice thawed, March 17, 2026. Left without phone, wallet, or coat. |
...
| Name | Role | Platform | Evidence Rating | Details |
|------|------|----------|-----------------|---------|
| [Paul Brown](Details/Paul_Brown.md) | Nuclear Physicist / Inventor | US Patent 4,835,433 | **MODERATE EVIDENCE** | Invented the Resonant Nuclear Battery (Nucell) using high-Q LC tank circuits for direct alpha-decay-to-AC conversion, claiming 100,000x energy density improvement. Also developed photoremediation technology. Killed in car accident after years of harassment. |
...
|----------|------|---------|
| [Books on UAP Physics](Details/Books.md) | Books | 50+ books covering energy sources, propulsion, spacetime manipulation, exotic materials, whistleblower accounts, and investigative journalism. Organized by thesis category with evidence ratings. |
| [Podcasts on UAP Physics](Details/Podcasts.md) | Podcasts | 15+ dedicated UAP/physics podcasts and 25+ landmark episodes on mainstream shows (Joe Rogan, Lex Fridman, Shawn Ryan). Key disclosure moments reached their largest audiences through podcasts. |
| [YouTube Channels on UAP Physics](Details/YouTube_Channels.md) | YouTube | 29 dedicated channels and 17+ notable videos from major platforms. Ranges from former military pilots to physics PhD interviews to congressional hearing recordings. |

---

## Patterns Worth Noting

**Convergent Theses from Independent Researchers:** Multiple independent researchers — [Hal Puthoff](Details/Hal_Puthoff.md) (theoretical physicist), [Bob Lazar](Details/Bob_Lazar.md) (claimed insider), [Salvatore Pais](Details/Salvatore_Pais.md) (Navy engineer), [Thomas Townsend Brown](Details/Thomas_Townsend_Brown.md) (electrogravitics pioneer), [Ning Li](Details/Ning_Li.md) (superconductor antigravity) — arrived at similar conclusions about gravity manipulation and vacuum energy from different starting points. Puthoff derived it from quantum electrodynamics, Lazar claimed to have seen it in classified programs, Pais patented engineering implementations, Brown demonstrated it experimentally in the 1950s, and Li published peer-reviewed theory in the 1990s. This convergence is either coordinated disinformation or independent confirmation.

**The 1950s Classification Wall:** [Electrogravitics research](Details/Electromagnetic_Propulsion.md) was openly published in aerospace journals through 1956, then abruptly vanished from the public literature. [Thomas Townsend Brown's](Details/Thomas_Townsend_Brown.md) work was central to this — his Biefeld-Brown effect demonstrations and Project Winterhaven proposal were openly discussed before the classification wall descended. The Aviation Studies International report on electrogravitics (1956) documented active programs at major defense contractors. [Wilbert Smith's](Details/Wilbert_Smith.md) 1950 classified Canadian memo confirmed US UFO programs existed and were rated higher than the H-bomb. After classification, the topic became taboo in academia. This is the clearest documented case of a physics discipline being classified out of public view.

**Navy Patent Clustering:** Between 2015-2018, the US Navy filed a cluster of extraordinary patents describing [inertial mass reduction](Details/Zero_Point_Energy.md), [high-frequency gravitational wave generation](Details/Zero_Point_Energy.md), room-temperature superconductors, and compact fusion reactors. The Navy's CTO personally intervened to get [Pais's](Details/Salvatore_Pais.md) patents approved, citing Chinese competition. Either the Navy is seriously pursuing these physics — or the patents serve a strategic disinformation purpose. Either explanation is significant.

**The 38 DIRDs:** The AAWSAP program (2008-2012) commissioned 38 Defense Intelligence Reference Documents covering [zero-point energy](Details/Zero_Point_Energy.md), [warp drives](Details/Alcubierre_Warp_Drive.md), [extra dimensions](Details/Interdimensional_Hypothesis.md), antigravity, metamaterials, and other exotic physics. These were official DIA-funded studies by credentialed physicists, coordinated by [Hal Puthoff](Details/Hal_Puthoff.md) and authored by researchers including [Eric Davis](Details/Eric_Davis.md). 37 of 38 were released via FOIA in 2022. Their existence confirms the US government took these physics topics seriously enough to commission formal technical assessments.

**Whistleblower Consistency Across Programs:** Independent whistleblowers from different decades and different alleged programs describe remarkably similar physics: [gravity amplification](Details/Gravity_Manipulation.md), element 115 or similar exotic fuel, [vacuum energy manipulation](Details/Zero_Point_Energy.md), and craft that warp spacetime rather than push against air. [Lazar](Details/Bob_Lazar.md) (1989), [Elizondo](Details/Luis_Elizondo.md) (2017-2024), and [Grusch](Details/David_Grusch.md) (2023) describe consistent mechanisms despite decades between their disclosures.
...
**The Reverse Engineering Pipeline:** [Philip Corso](Details/Philip_Corso.md) described a specific mechanism for how recovered technology was seeded to defense contractors via Army R&D contracts. [Boyd Bushman](Details/Boyd_Bushman.md) at Lockheed Martin conducted gravity experiments and made deathbed claims about reverse-engineering programs. [William McCasland](Details/William_McCasland.md) commanded the Air Force Research Laboratory with its advanced propulsion programs. [Gary McKinnon](Details/Gary_McKinnon.md) found references to "Non-Terrestrial Officers" in military computers. Together, these accounts describe a pipeline from recovery to contractor reverse-engineering that operates outside normal government oversight.
...
- **[David Grusch](Details/David_Grusch.md) Congressional Testimony (July 26, 2023):** Former intelligence officer testified under oath before the House Oversight Committee that the US government possesses recovered UAP craft and materials of non-human origin, and that reverse-engineering programs exist within legacy Special Access Programs
...
- **[Salvatore Pais](Details/Salvatore_Pais.md) Navy Patents (2016-2018):** The US Navy filed patents for inertial mass reduction devices, high-frequency gravitational wave generators, compact fusion reactors, and room-temperature superconductors
- **AAWSAP/AATIP DIRDs (2008-2012, released 2022):** 38 Defense Intelligence Reference Documents covering exotic physics topics, commissioned by the DIA and authored by credentialed physicists including [Hal Puthoff](Details/Hal_Puthoff.md) and [Eric Davis](Details/Eric_Davis.md)
- **[Eric Davis](Details/Eric_Davis.md) Classified Congressional Briefings (2008-2021):** Astrophysicist Eric Davis briefed the Senate Armed Services Committee, House Armed Services Committee, and Senate Select Committee on Intelligence about retrievals from *"off-world vehicles not made on this earth,"* adding *"We couldn't make it ourselves."* He asserted UAPs operate on *"a new physics"* but *"guaranteed that no laws of physics are broken whatsoever"* — meaning the physics is real but beyond our current understanding
- **[Luis Elizondo's](Details/Luis_Elizondo.md) "Imminent" (2024):** Former AATIP director's NYT bestseller describes the "prevailing theory" that UAPs have an energy source that, at a specific frequency, interacts with the craft's skin to create a "bubble" that alters spacetime — enabling instantaneous acceleration and hypersonic velocity without inertial effects. He has stated that UAP anti-gravity technology is "almost understood" by researchers
...
1. **Spacetime/Gravity Manipulation (Strongest Consensus):** The most widely held view is that UAPs manipulate local spacetime geometry — creating a "warp bubble" or gravity well that the craft "falls into," enabling apparent acceleration without inertial effects. Supported by [Elizondo](Details/Luis_Elizondo.md), [Puthoff](Details/Hal_Puthoff.md), [Davis](Details/Eric_Davis.md), the [Navy patents](Details/Salvatore_Pais.md), and DIA-funded research. The craft doesn't move through space — space moves around the craft.

2. **Zero-Point Energy as Power Source:** Many researchers ([Puthoff](Details/Hal_Puthoff.md), [Davis](Details/Eric_Davis.md), the [Pais patents](Details/Salvatore_Pais.md)) point to the [quantum vacuum](Details/Zero_Point_Energy.md) as the energy source. If you can extract energy from the quantum vacuum, you have an essentially limitless power source.
...
4. **[Metamaterials](Details/Exotic_Metamaterials.md) as Key Technology:** Recovered materials with anomalous isotope ratios and engineered layered structures suggest materials that interact with electromagnetic fields and spacetime in ways conventional materials cannot. [Garry Nolan](Details/Garry_Nolan.md) at Stanford has conducted the most rigorous public analysis.

5. **Classification, Not Impossibility:** [Davis's](Details/Eric_Davis.md) critical framing — *"no laws of physics are broken whatsoever"* — and [Puthoff's](Details/Hal_Puthoff.md) *"if it's real, it's physics"* represent the consensus that this is engineering beyond our capability, not magic. The physics exists but has been classified.

6. **The 1950s Classification Event:** Nick Cook's discovery that every major aerospace firm was researching gravity control in the mid-1950s, combined with Andreessen's confirmation that "entire branches of physics went dark," supports the timeline that [electrogravitics](Details/Electromagnetic_Propulsion.md) research was classified around 1955-1960 and removed from public science.
...
- [Nuno Loureiro](Details/Nuno_Loureiro.mdx) — MIT plasma physicist, shot 2025
...
- [Hal Puthoff](Details/Hal_Puthoff.md) — UAP Physics (zero-point energy, AAWSAP) and Deep State (intelligence connections)
- [Garry Nolan](Details/Garry_Nolan.md) — UAP Physics (material analysis) and scientific establishment
- [David Grusch](Details/David_Grusch.md) — UAP Physics (reverse engineering testimony) and Deep State (whistleblower retaliation)
- [Thomas Townsend Brown](Details/Thomas_Townsend_Brown.md) — UAP Physics (electrogravitics pioneer) and [UAP Deaths](/uaps/Details/Thomas_Townsend_Brown) (classified research)
- [Ning Li](Details/Ning_Li.md) — UAP Physics (superconductor antigravity) and [UAP Deaths](/uaps/Details/Ning_Li) (struck by vehicle, brain damage)
- [Nikola Tesla](Details/Nikola_Tesla.md) — UAP Physics (energy/propulsion concepts) and [UAP Deaths](/uaps/Details/Nikola_Tesla) (seized papers)
- [Stanley Meyer](Details/Stanley_Meyer.md) — UAP Physics (water fuel cell) and [UAP Deaths](/uaps/Details/Stanley_Meyer) (poisoned)
- [Mark McCandlish](Details/Mark_McCandlish.md) — UAP Physics (ARV/Flux Liner) and [UAP Deaths](/uaps/Details/Mark_McCandlish) (died before testimony)
- [Stanton Friedman](Details/Stanton_Friedman.md) — UAP Physics (MHD propulsion) and [UAP Deaths](/uaps/Details/Stanton_Friedman) (nuclear physicist)
- [Philip Corso](Details/Philip_Corso.md) — UAP Physics (reverse engineering) and [UAP Deaths](/uaps/Details/Philip_Corso) (Army R&D)
- [Eugene Mallove](Details/Eugene_Mallove.md) — UAP Physics (cold fusion) and [UAP Deaths](/uaps/Details/Eugene_Mallove) (beaten to death)
- [Boyd Bushman](Details/Boyd_Bushman.md) — UAP Physics (Lockheed experiments) and [UAP Deaths](/uaps/Details/Boyd_Bushman) (deathbed disclosure)
- [Amy Eskridge](Details/Amy_Eskridge.md) — UAP Physics (exotic science) and [UAP Deaths](/uaps/Details/Amy_Eskridge) (suspicious death)
- [Floyd Sweet](Details/Floyd_Sweet.md) — UAP Physics (vacuum energy) and [UAP Deaths](/uaps/Details/Floyd_Sweet) (death threats, materials seized)
- [Bruce DePalma](Details/Bruce_DePalma.md) — UAP Physics (N-Machine) and [UAP Deaths](/uaps/Details/Bruce_DePalma) (died before testing)
- [Paul Brown](Details/Paul_Brown.md) — UAP Physics (nuclear battery) and [UAP Deaths](/uaps/Details/Paul_Brown) (killed in car accident)
- [Arie DeGeus](Details/Arie_DeGeus.md) — UAP Physics (ZPE battery) and [UAP Deaths](/uaps/Details/Arie_DeGeus) (found dead)
- [Ryan Graves](Details/Ryan_Graves.md) — UAP Physics (Five Observables testimony) and [UAP Deaths](/uaps/Details/Ryan_Graves) (military pilot)
- [Wilbert Smith](Details/Wilbert_Smith.md) — UAP Physics (Project Magnet) and [UAP Deaths](/uaps/Details/Wilbert_Smith) (Canadian government engineer)
- [Morris Jessup](Details/Morris_Jessup.md) — UAP Physics (unified field theory) and [UAP Deaths](/uaps/Details/Morris_Jessup) (suspicious death)
...
|---|------|--------------|-----------------|
| 1 | [Eugene Mallove](Details/Eugene_Mallove.md) | Cold fusion advocate murdered in 2004 | **MURDERED** |
...
| 23 | [Nuno Loureiro](Details/Nuno_Loureiro.mdx) | MIT plasma physicist and Fusion Center Director; shot at home Dec 2025; part of cluster of scientist deaths cited by Rep. Burchett | **SUSPICIOUS** |
