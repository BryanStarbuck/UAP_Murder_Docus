---
title: "Al Wordsworth"
description: "Inventor of an overunity electrical generator (3A input / 32A output) and an advanced carburetor, both of which were allegedly suppressed through harassment...."
keywords:
  - Al Wordsworth
  - UAP murders
  - UFO whistleblower
...
<Head>
  <script type="application/ld+json">{"{\"@context\":\"https://schema.org\",\"@type\":\"Person\",\"name\":\"Al Wordsworth\",\"description\":\"Inventor of an overunity electrical generator (3A input / 32A output) and an advanced carburetor, both of which were allegedly suppressed through harassment....\",\"url\":\"https://uapmurders.com/uaps/Details/Al_Wordsworth\",\"image\":\"https://uapmurders.com/img/social-card-2026-08.jpg\"}"}</script>
</Head>
...
After Wordsworth's death, his generator design was reportedly lost. This follows the pattern seen with numerous other energy inventors, including [Lester Hendershot](Lester_Hendershot.mdx) (fuelless motor never reproduced), [Thomas Henry Moray](Thomas_Henry_Moray.mdx) (radiant energy device destroyed), [Floyd Sweet](Floyd_Sweet.mdx) (research materials confiscated after death), and [Rory Johnson](Rory_Johnson.mdx) (Magnatron disappeared).
...
- **Consistent with broader pattern:** Inventors of claimed overunity devices have died under suspicious circumstances at a rate that exceeds coincidence — [Stanley Meyer](Stanley_Meyer.mdx), [Arie DeGeus](Arie_DeGeus.mdx), [Mark Tomion](Mark_Tomion.mdx), [John Bedini](John_Bedini.mdx), [Floyd Sweet](Floyd_Sweet.mdx)
...
- [Thomas Bearden](Thomas_Bearden.mdx) — Inventor of the Motionless Electromagnetic Generator (MEG), US Patent 6,362,718
- [Floyd Sweet](Floyd_Sweet.mdx) — Inventor of the Vacuum Triode Amplifier, research confiscated after death
- [John Bedini](John_Bedini.mdx) — Free energy researcher who died suddenly in 2016
- [Tom Ogle](Tom_Ogle.mdx) — Inventor of advanced fuel vapor system, died of overdose ruled suicide
...
- [Frederick Hochstetter](Frederick_Hochstetter.mdx): Sole passenger killed in a train wreck after debunking a fuelless motor inventor.
- [Alistair Beckham](Alistair_Beckham.mdx): SDI engineer found electrocuted in his garden shed — wires on chest, handkerchief jammed in mouth.
