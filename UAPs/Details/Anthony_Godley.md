...
Godley's position gave him access to sensitive defense work. Notably, at least two other individuals connected to the RCMS — [John Brittan](John_Brittan.md) and [Peter Peapell](Peter_Peapell.md) — also died under suspicious circumstances during the Marconi cluster period, making Shrivenham a geographic node in the death pattern.
...
- At least two other RCMS-connected individuals ([John Brittan](John_Brittan.md), [Peter Peapell](Peter_Peapell.md)) died suspiciously during the same period
