...
1. **Benito Que** (November 12, 2001) — found beaten/cardiac arrest, Miami
2. **Don C. Wiley** (November 15, 2001) — disappeared, found in Mississippi River
3. **Vladimir Pasechnik** (November 21, 2001) — stroke, England
4. **Robert Schwartz** (December 10, 2001) — stabbed, Virginia
5. **Set Van Nguyen** (December 14, 2001) — found dead in airlock at CSIRO, Australia
6. **Nguyen Van Set** (same person, different reporting)
7. Multiple additional microbiologists in early 2002
