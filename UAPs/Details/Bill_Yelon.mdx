---
title: "Bill Yelon"
description: "Inventor of a solid-state electromagnetic wave over-unity device who reportedly died suddenly in 2018, shortly after announcing his device."
keywords:
  - Bill Yelon
  - UAP murders
  - UFO whistleblower
...
<Head>
  <script type="application/ld+json">{"{\"@context\":\"https://schema.org\",\"@type\":\"Person\",\"name\":\"Bill Yelon\",\"description\":\"Inventor of a solid-state electromagnetic wave over-unity device who reportedly died suddenly in 2018, shortly after announcing his device.\",\"url\":\"https://uapmurders.com/uaps/Details/Bill_Yelon\",\"image\":\"https://uapmurders.com/img/social-card-2026-08.jpg\"}"}</script>
</Head>
...
- [Arie DeGeus](Arie_DeGeus.mdx) died of heart failure in an airport parking lot while en route to secure funding (2007)
- [Stanley Meyer](Stanley_Meyer.mdx) died at a restaurant during a meeting with Belgian investors (1998)
- [Eugene Mallove](Eugene_Mallove.mdx) was killed days before a major Coast to Coast AM appearance (2004)
- [Mark Tomion](Mark_Tomion.mdx) died of a sudden cardiac event after developing a working Star Drive prototype (2009)
...
- [Thomas Bearden](Thomas_Bearden.mdx) — Motionless Electromagnetic Generator (MEG), US Patent 6,362,718
- [Floyd Sweet](Floyd_Sweet.mdx) — Vacuum Triode Amplifier (claimed 500W from 33 microwatts input)
- [Paulo and Alexandra Correa](Paulo_Correa.mdx) — Pulsed Abnormal Glow Discharge (PAGD) reactor
...
- **Pattern consistency:** The trajectory — announcement followed by sudden death — mirrors [Arie DeGeus](Arie_DeGeus.mdx), [Stanley Meyer](Stanley_Meyer.mdx), and [Mark Tomion](Mark_Tomion.mdx)
...
- [Thomas Bearden](Thomas_Bearden.mdx) — Inventor of the Motionless Electromagnetic Generator (MEG), a solid-state overunity device
- [Floyd Sweet](Floyd_Sweet.mdx) — Inventor of the Vacuum Triode Amplifier, received death threats, research confiscated after death
- [Arie DeGeus](Arie_DeGeus.mdx) — Died of heart failure while en route to secure funding for clean energy technology
- [Stanley Meyer](Stanley_Meyer.mdx) — Died during investor meeting, said "They poisoned me"
- [Mark Tomion](Mark_Tomion.mdx) — Died of sudden cardiac event after developing Star Drive prototype
...
- [David Greenhalgh](David_Greenhalgh.mdx): Fell from a railway bridge on his way to work. Survived briefly but could never explain why.
- [Eric Wang](Eric_Wang.mdx): Headed Wright-Patterson's Office of Special Studies. Died at 54 — no cause of death ever stated.
- [Vimal Dajibhai](Vimal_Dajibhai.mdx): Marconi torpedo guidance scientist found dead at Clifton Suspension Bridge. He was 24 years old.
