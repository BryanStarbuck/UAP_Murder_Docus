---
title: "Gianni A. Dotto"
description: "Italian-American bio-physicist and inventor of the Dotto Ring thermionic couple, a device claimed to reverse aging and cure cancer by replicating the..."
keywords:
  - Gianni A. Dotto
  - UAP murders
  - UFO whistleblower
...
<Head>
  <script type="application/ld+json">{"{\"@context\":\"https://schema.org\",\"@type\":\"Person\",\"name\":\"Gianni A. Dotto\",\"description\":\"Italian-American bio-physicist and inventor of the Dotto Ring thermionic couple, a device claimed to reverse aging and cure cancer by replicating the...\",\"url\":\"https://uapmurders.com/uaps/Details/Gianni_A_Dotto\",\"image\":\"https://uapmurders.com/img/social-card-2026-08.jpg\"}"}</script>
</Head>
...
- **Method of alleged murder:** Being run over multiple times is a method designed to ensure death and could be made to appear as an accident — similar to how [Paul Brown](Paul_Brown.mdx)'s fatal car crash may have been staged
...
- [Wilhelm Reich](Wilhelm_Reich.mdx) — Orgone energy inventor whose devices were destroyed by FDA court order; books burned; died in federal prison
- [Nikola Tesla](Nikola_Tesla.mdx) — Wireless energy pioneer whose papers were seized by the FBI after death
- [Paul Pantone](Paul_Pantone.mdx) — GEET reactor inventor committed to mental hospital after regulatory action
- [Thomas Henry Moray](Thomas_Henry_Moray.mdx) — Radiant energy inventor whose lab was ransacked and device destroyed

## Other Shocking Stories

- [Shani Warren](Shani_Warren.mdx): Found drowned, gagged, and bound in a lake. Worked at firm later acquired by GEC-Marconi.
