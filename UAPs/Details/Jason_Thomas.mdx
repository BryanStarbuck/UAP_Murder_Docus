---
title: "Jason Thomas"
description: "Assistant director of chemical biology at Novartis Institutes for BioMedical Research (NIBR) in Cambridge, Massachusetts. Disappeared from his Wakefield, MA..."
keywords:
  - Jason Thomas
  - UAP murders
  - UFO whistleblower
...
<Head>
  <script type="application/ld+json">{"{\"@context\":\"https://schema.org\",\"@type\":\"Person\",\"name\":\"Jason Thomas\",\"description\":\"Assistant director of chemical biology at Novartis Institutes for BioMedical Research (NIBR) in Cambridge, Massachusetts. Disappeared from his Wakefield, MA...\",\"url\":\"https://uapmurders.com/uaps/Details/Jason_Thomas\",\"image\":\"https://uapmurders.com/img/social-card-2026-08.jpg\"}"}</script>
</Head>
...
- [Nuno Loureiro](Nuno_Loureiro.mdx) — MIT plasma physicist murdered three days after Thomas vanished, approximately 10 miles away
- [William McCasland](William_McCasland.mdx) — Retired USAF Major General who disappeared from Albuquerque two months after Thomas vanished
- [Monica Jacinto Reza](Monica_Jacinto_Reza.mdx) — Aerospace materials scientist missing since June 2025; part of the same five-scientist cluster
- [Carl Grillmair](Carl_Grillmair.mdx) — Caltech astrophysicist killed February 2026; part of the same five-scientist cluster
...
- [Ron Johnson](Ron_Johnson.mdx): MUFON deputy director collapsed dead at conference after sipping from a soda can — purple face, blood from nose.
- [Todd Sees](Todd_Sees.mdx): Pennsylvania deer hunter found dead near home with "cocaine toxicity" ruling — multiple witnesses reported UFO on same ridge that morning.
- [Amy Eskridge](Amy_Eskridge.mdx): Co-founded Institute for Exotic Science; ruled suicide, retired UK intel officer alleged to Congress she was murdered by private aerospace company.
