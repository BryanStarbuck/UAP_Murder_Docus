---
title: "John Lear"
description: "Son of Learjet inventor Bill Lear, CIA contract pilot for 16 years, and the most influential UAP conspiracy theorist of the late 1980s — who introduced Bob..."
keywords:
  - John Lear
  - UAP murders
  - UFO whistleblower
...
<Head>
  <script type="application/ld+json">{"{\"@context\":\"https://schema.org\",\"@type\":\"Person\",\"name\":\"John Lear\",\"description\":\"Son of Learjet inventor Bill Lear, CIA contract pilot for 16 years, and the most influential UAP conspiracy theorist of the late 1980s — who introduced Bob...\",\"url\":\"https://uapmurders.com/uaps/Details/John_Lear\",\"image\":\"https://uapmurders.com/img/social-card-2026-08.jpg\"}"}</script>
</Head>
...
| Field | Details |
|-------|---------|
| **Full Name** | John Olsen Lear |
| **Born** | December 3, 1942 |
| **Died** | March 29, 2022 |
| **Age at Death** | 79 |
| **Location of Death** | Nevada, United States |
| **Cause of Death** | Natural causes |
| **Official Ruling** | Natural causes |
| **Nationality** | American |
| **Killed on US Soil** | Yes |
| **Category** | UFO/UAP Researcher / Intelligence-Connected |
| **Investigation** | UAPs |
...
> "John Lear would say that there was like a soul catcher on the moon, but he also was kind of crazy and would say a lot of stuff that, you know, probably was BS. I guess my point is we don't need to depend on him — other people have said this."
> — UAP researcher, April 8, 2026 (video posted by @D4rk_n3ws on X)

## See Also

- [Robert Monroe](Robert_Monroe.mdx) — Monroe Institute founder whose loosh framework parallels Lear's soul catcher theory
- [Karla Turner](Karla_Turner.mdx) — Abduction researcher whose interviewees independently described the same control system structure
- [Ian Stevenson](Ian_Stevenson.mdx) — UVA reincarnation researcher whose interval data supports the soul recycling framework

## Other Shocking Stories

- [Ron Rummel](Ron_Rummel.mdx): Ex-Air Force intelligence agent found with gunshot in mouth ruled suicide — no fingerprints on gun, suicide note written with wrong hand, body cremated without autopsy.
- [Phil Schneider](Phil_Schneider.mdx): Former government geologist found strangled with his own catheter after two years of lectures about underground bases and alien confrontations.
- [Danny Casolaro](Danny_Casolaro.mdx): Journalist found with wrists slashed 12 times in a hotel bathtub after warning brother not to believe it was an accident.
- [Mark McCandlish](Mark_McCandlish.mdx): Aerospace illustrator died by shotgun blast days before scheduled Senate UAP testimony.

## Sources

- [John Lear — Wikipedia](https://en.wikipedia.org/wiki/John_Lear_(conspiracy_theorist))
- [Bob Lazar — Wikipedia](https://en.wikipedia.org/wiki/Bob_Lazar)
- [The Lear Statement, ParaNet, December 29, 1987]
- [Coast to Coast AM appearances, John Lear (2003–2015)]
