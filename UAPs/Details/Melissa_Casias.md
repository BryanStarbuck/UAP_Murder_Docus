...
The Casias family's connection to LANL places them within the same institutional ecosystem as [Anthony Chavez](Anthony_Chavez.md), a longtime LANL employee who vanished from Los Alamos seven weeks earlier.
...
- [Amy Eskridge](Amy_Eskridge.md) — Gravity modification researcher allegedly murdered by directed energy weapons
- [Jonathan Lovette](Jonathan_Lovette.md) — Air Force sergeant allegedly dragged into hovering craft; body found mutilated
- [Phil Schneider](Phil_Schneider.md) — Ex-government geologist strangled after lecturing about underground bases
