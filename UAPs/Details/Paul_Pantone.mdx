---
title: "Paul Pantone"
description: "Inventor of the GEET plasma reactor who was involuntarily committed to a state mental hospital and died after years of health deterioration."
keywords:
  - Paul Pantone
  - UAP murders
  - UFO whistleblower
...
<Head>
  <script type="application/ld+json">{"{\"@context\":\"https://schema.org\",\"@type\":\"Person\",\"name\":\"Paul Pantone\",\"description\":\"Inventor of the GEET plasma reactor who was involuntarily committed to a state mental hospital and died after years of health deterioration.\",\"url\":\"https://uapmurders.com/uaps/Details/Paul_Pantone\",\"image\":\"https://uapmurders.com/img/social-card-2026-08.jpg\"}"}</script>
</Head>
...
- [Wilhelm Reich](Wilhelm_Reich.mdx) — Scientist imprisoned by the government; books burned by court order
- [Joseph Westley Newman](Joseph_Westley_Newman.mdx) — Energy Machine inventor who fought the US Patent Office for 7+ years
...
- [John Kanzius](John_Kanzius.mdx) — RF water-splitting inventor whose research stalled after his death from cancer
- [Tom Ogle](Tom_Ogle.mdx) — 100+ MPG fuel system inventor shot and poisoned before age 26
- [Paul Bennewitz](Paul_Bennewitz.mdx) — UFO researcher driven to breakdown by government disinformation, another case of institutional targeting
- [Andrija Puharich](Andrija_Puharich.mdx) — Medical inventor with water-splitting patent whose lab was burned down
- [John Bedini](John_Bedini.mdx) — Free energy device inventor who died in 2016

## Other Shocking Stories

- [William Neil McCasland](William_McCasland.mdx): Retired general who oversaw every SAP in the DOD. Vanished from his home. FBI searching.
- [Viktor Schauberger](Viktor_Schauberger.mdx): Signed away all rights under duress in America. Died five days after returning to Austria.
...
- [Paul Brown](Paul_Brown.mdx): Home robbed three times, mother's car pipe-bombed. Died in car accident. Nuclear battery inventor.
...
- [Stanley Meyer](Stanley_Meyer.mdx) — Water fuel cell inventor who died suddenly in 1998
- [Rory Johnson](Rory_Johnson.mdx) — Magnatron inventor targeted by DOE gag and grab orders
- [Daniel Dingel](Daniel_Dingel.mdx) — Filipino water-powered car inventor who died in prison after conviction
- [Gerald Schaflander](Gerald_Schaflander.mdx) — Energy inventor imprisoned on questionable charges related to his technology
- [Tom Ogle](Tom_Ogle.mdx) — 100+ MPG engine inventor who was shot and poisoned before age 26
- [John Kanzius](John_Kanzius.mdx) — Discovered RF-induced salt water dissociation; research stalled after his death
- [Bob Boyce](Bob_Boyce.mdx) — Electrolyzer inventor who survived multiple attacks related to his hydrogen technology
