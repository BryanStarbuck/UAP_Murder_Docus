...
- **Abductee testimonies** collected by [Karla Turner](Karla_Turner.md), whose abductees described the same control system managed from a metallic sphere near Earth
...
Monroe's loosh framework is directly relevant to abductee reports collected by researchers including [Karla Turner](Karla_Turner.md). Turner's abductees — without knowledge of Monroe's framework — described:
...
- [Karla Turner](Karla_Turner.md) — Abduction researcher whose interviewees independently described Monroe's loosh farm structure
- [John Lear](John_Lear.md) — CIA pilot who claimed a "soul catcher" apparatus exists on the Moon, parallel to Monroe's framework
- [Ian Stevenson](Ian_Stevenson.md) — UVA researcher whose reincarnation interval data intersects with Monroe's loosh recycling framework
- [Peter Jennings](Peter_Jennings.md) — Journalist who died of fast-acting cancer months after airing a major UFO whistleblower special

## Other Shocking Stories

- [Karla Turner](Karla_Turner.md): Ph.D. abduction researcher died of fast-acting cancer at 48 after receiving threats for publishing disturbing evidence of a soul-harvesting control system.
- [Ron Johnson](Ron_Johnson.md): MUFON deputy director collapsed with purple face and blood from his nose after sipping from a soda can at a UAP conference.
- [Danny Casolaro](Danny_Casolaro.md): Journalist investigating classified programs, warned brother not to believe it was an accident — found dead with wrists slashed 12 times in a hotel bathtub.
